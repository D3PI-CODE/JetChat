                        ...
                        <div
                            ...
                            className={`flex cursor-pointer gap-4 px-6 py-4 justify-between transition-all duration-700 ease-out hover:scale-[1.02] hover:-translate-y-0.5 group relative overflow-hidden ${
                                activeChat?.userID === u.userID
                                    ? 'bg-gradient-to-r from-blue-500/20 to-blue-600/12 border-r-2 border-blue-400/90 shadow-xl shadow-blue-500/15'
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4 relative z-10">
                                <div className="relative shrink-0">
                                    <div className="absolute inset-0 bg-gradient-to-br from-white/25 to-white/8 rounded-full blur-sm group-hover:blur-lg group-hover:scale-110 transition-all duration-700 ease-out"></div>
                                    <div
